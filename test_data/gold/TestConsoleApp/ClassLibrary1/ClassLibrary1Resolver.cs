public partial class ClassLibrary1Resolver
{
  ...
  )
  {
    ...
    {
      return new TComponent[] {(TComponent)((object)ClassLibrary2.Class4Container.Resolve()),(TComponent)((object)ClassLibrary2.Class5Container.Resolve()),(TComponent)((object)ClassLibrary1.Class3Container.Resolve()),(TComponent)((object)ClassLibrary1.Class1Container.Resolve())};
    }
    throw new ArgumentOutOfRangeException();
  }
