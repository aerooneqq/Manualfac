  ...
  public partial class Class5Container
  {
    ...
    )
    {
      var created = new DefaultNamespace.Class5(
        new DefaultNamespace.IClass1[] {DefaultNamespace.Class4Container.Resolve(),DefaultNamespace.Class2Container.Resolve(),DefaultNamespace.Class1Container.Resolve(),DefaultNamespace.Class3Container.Resolve()}
      );
      return created;
    }
