public partial class compilationResolver
{
  ...
  )
  {
    ...
    {
      return new TComponent[] {(TComponent)((object)DefaultNamespace.Class4Container.Resolve()),(TComponent)((object)DefaultNamespace.Class2Container.Resolve()),(TComponent)((object)DefaultNamespace.Class1Container.Resolve()),(TComponent)((object)DefaultNamespace.Class3Container.Resolve())};
    }
    throw new ArgumentOutOfRangeException();
  }
